                    ...
                    switch (_f.label) {
                        ...
                        case 1:
                            return [
                                4 /*yield*/,
                                _c.apply(_b, [
                                    ((_d.params = ((_e.tenantId = _f.sent() || "public"), _e)), _d),
                                    { body: bodyObj },
                        ...
                        case 2:
                            (_a = _f.sent()), (jsonBody = _a.jsonBody), (fetchResponse = _a.fetchResponse);
                    ...
                    switch (_f.label) {
                        ...
                        case 1:
                            return [
                                ...
                                _c.apply(_b, [
                                    ((_d.params =
                                        ((_e.tenantId = _f.sent() || "public"), (_e.email = input.email), _e)),
                                    _d),
                                    {},
                                    querier_1.default.preparePreAPIHook({
                                        recipePreAPIHook: recipeImplInput.preAPIHook,
                    ...
                    switch (_f.label) {
                        ...
                        case 1:
                            return [
                                ...
                                _c.apply(_b, [
                                    ((_d.params =
                                        ((_e.tenantId = _f.sent() || "public"),
                                        (_e.phoneNumber = input.phoneNumber),
                                        _e)),
                                    _d),
                                    {},
                                    querier_1.default.preparePreAPIHook({
