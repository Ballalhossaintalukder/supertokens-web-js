...
var RecipeWrapper = /** @class */ (function () {
     ...
     */
    RecipeWrapper.createCredential = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.createCredential(input);
    };
    /**
     ...
     * @returns `{ status: "OK", ...}` if successful
     */
    RecipeWrapper.registerCredentialWithUser = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.registerCredentialWithUser(
            __assign(__assign({}, input), {
                userContext: input === null || input === void 0 ? void 0 : input.userContext,
            })
        );
     ...
     */
    RecipeWrapper.listCredentials = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.listCredentials(
            __assign(__assign({}, input), {
                userContext: input === null || input === void 0 ? void 0 : input.userContext,
            })
        );
     ...
     * @returns `{ status: "OK", ...}` if successful
     */
    RecipeWrapper.removeCredential = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.removeCredential(
            __assign(__assign({}, input), {
                userContext: input === null || input === void 0 ? void 0 : input.userContext,
            })
        );
    ...
    RecipeWrapper.doesBrowserSupportWebAuthn = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.doesBrowserSupportWebAuthn(input);
    };
...
var createCredential = RecipeWrapper.createCredential;
...
var doesBrowserSupportWebAuthn = RecipeWrapper.doesBrowserSupportWebAuthn;
exports.doesBrowserSupportWebAuthn = doesBrowserSupportWebAuthn;
var listCredentials = RecipeWrapper.listCredentials;
exports.listCredentials = listCredentials;
var removeCredential = RecipeWrapper.removeCredential;
...
var registerCredentialWithUser = RecipeWrapper.registerCredentialWithUser;
