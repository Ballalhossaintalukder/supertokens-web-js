    ...
    return {
        ...
        isEmailVerified: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, querier.get("/user/email/verify", {}, querier_1.default.preparePreAPIHook({
                                recipePreAPIHook: recipeImpleInput.preAPIHook,
        ...
        sendVerificationEmail: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, querier.post("/user/email/verify/token", {
                                body: undefined,
                            }, querier_1.default.preparePreAPIHook({
                                recipePreAPIHook: recipeImpleInput.preAPIHook,
