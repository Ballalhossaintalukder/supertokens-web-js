...
var Querier = /** @class */ (function () {
    function Querier(recipeId, appInfo) {
        ...
        this.getPath = function (path) {
            ...
            var params = typeof path === "string" ? {} : (_b = path.params) !== null && _b !== void 0 ? _b : {};
            var populated = String(template);
            for (var _i = 0, _c = Object.entries(params); _i < _c.length; _i++) {
                var _d = _c[_i],
                    key = _d[0],
                    value = _d[1];
                populated = populated.replace(new RegExp("<".concat(key, ">\\b"), "g"), String(value));
            }
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            return [
                                ...
                                this.fetch(
                                    path,
                                    __assign(__assign({ method: "GET" }, config), {
        ...
        this.getFullUrl = function (path) {
            ...
            return ""
                ...
                .concat(basePath)
                .concat(normalisedPath.getAsStringDangerous());
        };
